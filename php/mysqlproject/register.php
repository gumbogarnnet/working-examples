...
if ($_POST['email'] AND $_POST['password']) {
    if (!$_POST['aggree']) {
        $error = "You must agree before you can procceed";
    }
    }

if ($error) {
    $errormsg ='<div class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
                                            <span class="badge badge-pill badge-danger">ooops!</span><br />
                                            '.$error.'
...
if ($check) {
   ...
   $errormsg ='<div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <form action="" method="post">
                                ...
                                <input class="au-btn au-btn--block au-btn--green m-b-20" type="submit" value="register" name="btnregister"/>
