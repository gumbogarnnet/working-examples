                            ...
                            <div class="header-button">
                                    ...
                                    echo '<div class="noti__item js-item-menu">
                                        ...
                                        <span class="quantity">1</span>
                                            ...
                                            <div class="mess__title">
                                                <p>96 recently added iterms</p>
                                            </div> ';
                                                 

                                                 $queryiterm = "SELECT * FROM `cartegory-iterm` WHERE `catergory` = '$cartId'";
                                            $resultiterm = mysqli_query($connection,$queryiterm);
                                            while ($rowIterm = mysqli_fetch_array($resultiterm)) {
                                                $name =$rowIterm['name'];
                                                 echo '
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">More</a>
                                        </div>
                            ...
                            <div class="row container" >
                                ...
                                <div class="card" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-danger">List Price: $'.(($price*100)/40).' </p>
                                         <p class="card-text"><strong>Our Price: $'.$price.'</strong>   </p>
                                         <button class="btn au-btn--submit myBtn" id="'.$id.'">Details</button>
                                    </div>
                                </div>
                            </div>';
